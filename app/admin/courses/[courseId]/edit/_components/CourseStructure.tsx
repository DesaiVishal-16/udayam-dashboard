...
interface SortableItemProps {
  ...
  data?: {
    type: "chapter" | "lesson";
    chapterId?: string; //only relevant to lessons
  };
}
                    ...
                    >
                      <div className="flex items-center justify-between p-3 border-b border-border">
                        <div className="flex items-center gap-2 ">
                          <Button size="icon" variant="ghost" {...listerners}>
                        ...
                        <div className="p-1">
                          ...
                          >
                            {item.lessons.map((lesson) => (
                              ...
                              >
                                {(lessonListeners) => (
                                  <div className="flex items-center justify-between p-2 hover:bg-gray-600 rounded-sm">
                                    <div className="flex items-center gap-2">
                                      <Button
                                        variant="ghost"
                                        size="icon"
