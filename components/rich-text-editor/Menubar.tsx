    ...
    <div className="border border-input rounded-t-lg p-2 bg-card flex flex-wrap gap-1 items-center border-t-0 border-x-0">
       <TooltipProvider>
        ...
        <div className="flex flex-wrap gap-1">
            <Tooltip>
                <TooltipTrigger asChild>
                 <Button onClick={()=>editor.chain().focus().undo().run()} size="sm" type="button" variant="ghost" disabled={!editor.can().undo()}>
                  <Undo/>
                 </Button> 
                </TooltipTrigger>
            ...
            <Tooltip>
                <TooltipTrigger asChild>
                 <Button onClick={()=>editor.chain().focus().redo().run()} size="sm" type="button" variant="ghost" disabled={!editor.can().redo()}>
                  <Redo/>
                 </Button> 
                </TooltipTrigger>
